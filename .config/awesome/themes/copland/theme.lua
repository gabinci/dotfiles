...
local mytextclock = wibox.widget.textclock("<span font='JetBrains Mono Nerd Font 4'> </span>%H:%M ")
...
-- Separators
local first = wibox.widget.textbox(markup.font("JetBrains Mono Nerd Font 3", " "))
-- local spr = wibox.widget.textbox(" ")
local small_spr = wibox.widget.textbox(markup.font("JetBrains Mono Nerd Font 4", " "))
